...
export default function PackingChecklist() {
  ...
  return <>
    ...
    {!plan.profile.classDate && <p className="mb-4 text-xs leading-5 text-slate-500">Cold-weather gear is required October–May. <Link href="/dashboard" className="font-semibold text-blue-700 underline">Add your class date</Link> to adjust your list.</p>}
