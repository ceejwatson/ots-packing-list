...
(async () => {
  ...
  console.log('PASS: mobile navigation, no horizontal overflow, packing/reload, filters, exclusions, class dates, reset and automatic saving, desktop navigation, fail-closed API, storage failure warning, failed-image shopping fallback, no page errors.');
  await browser.close();
