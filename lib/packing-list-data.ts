...
export const defaultOTSPackingList: Omit<PackingItem, 'id' | 'is_packed'>[] = [
  ...
  { category: 'Required', item_name: 'Toiletry bag', quantity: 1, amazon_search: 'Hanging+Toiletry+Bag+Travel+Organizer' },
  ...
  { category: 'Required', item_name: 'Gallon-sized ziplock bags', quantity: 5, notes: 'Clear', amazon_search: 'Ziploc+Storage+Bags+Gallon' },
  { category: 'Required', item_name: 'Sandwich-sized ziplock bags', quantity: 5, notes: 'Clear', amazon_search: 'Ziploc+Sandwich+Bags' },
  ...
  { category: 'Recommended', item_name: 'Mesh laundry bag', quantity: 1, amazon_search: 'Mesh+Laundry+Bags+Delicates' },
  { category: 'Recommended', item_name: 'Starch', quantity: 1, notes: 'For uniforms', amazon_search: 'Faultless+Heavy+Spray+Starch' },
  { category: 'Recommended', item_name: 'Hangers', quantity: 10, amazon_search: 'Zober+Black+Velvet+Hangers' },
  { category: 'Recommended', item_name: 'Laundry detergent', quantity: 1, amazon_search: 'Tide+PODS+Laundry+Detergent' },
  { category: 'Recommended', item_name: 'Sewing kit', quantity: 1, amazon_search: 'Military+Sewing+Kit+Compact' },
  { category: 'Recommended', item_name: 'Scissors', quantity: 1, amazon_search: 'Fiskars+Scissors+5+Inch' },
  { category: 'Recommended', item_name: 'Lint roller', quantity: 1, amazon_search: 'Scotch-Brite+Lint+Roller' },
  { category: 'Recommended', item_name: 'Bug spray', quantity: 1, amazon_search: 'Sawyer+Permethrin+Insect+Repellent' },
  { category: 'Recommended', item_name: 'Sunscreen', quantity: 1, notes: 'SPF 30+', amazon_search: 'Neutrogena+Ultra+Sheer+Sunscreen+SPF+70' },
  { category: 'Recommended', item_name: 'Blister prevention', quantity: 1, notes: 'Moleskin or similar', amazon_search: 'Dr+Scholls+Moleskin+Plus+Padding' },
  { category: 'Recommended', item_name: 'Pain relief medication', quantity: 1, notes: 'Over-the-counter (Motrin, Tylenol)', amazon_search: 'Advil+Ibuprofen+Travel+Pack' },
  { category: 'Recommended', item_name: 'Gloves', quantity: 2, notes: '1 warm pair, 1 work pair (not June-Sept)', amazon_search: 'Mechanix+Wear+Tactical+Gloves' },
