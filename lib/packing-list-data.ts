...
export const defaultOTSPackingList: Omit<PackingItem, 'id' | 'is_packed'>[] = [
  ...
  { category: 'Required', item_name: 'OCP patrol cap', quantity: 2, notes: '6-point and ball cap NOT authorized, 3 recommended', amazon_search: 'ocp+patrol+cap' },
  ...
  // REQUIRED ACCOUTREMENTS - AIR FORCE
  ...
  { category: 'Required', item_name: 'US lapel pins', quantity: 1, notes: 'Set of 2 for service coat (USSF lapel pin for USSF)', amazon_search: 'us+lapel+pin+air+force' },
  ...
  { category: 'Required', item_name: 'Combination locks', quantity: 2, notes: 'Combination style only', amazon_search: 'combination+padlock' },
  { category: 'Required', item_name: 'Sandwich-sized ziplock bags', quantity: 5, notes: 'Clear', amazon_search: 'ziplock+sandwich+bags' },
  { category: 'Required', item_name: 'Cell phone and charger', quantity: 1, notes: 'No restrictions after SMT' },
  ...
  { category: 'Recommended', item_name: 'OCP fleece jacket', quantity: 1, notes: 'Coyote brown, for cold weather (not June-Sept)', amazon_search: 'ocp+fleece+jacket+coyote+brown' },
  { category: 'Recommended', item_name: 'Watch cap', quantity: 1, notes: 'Black or coyote brown (not June-Sept)', amazon_search: 'watch+cap+coyote+brown' },
