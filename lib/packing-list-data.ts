...
export const defaultOTSPackingList: Omit<PackingItem, 'id' | 'is_packed'>[] = [
  ...
  { category: 'Required', item_name: 'Black ball point pens', quantity: 5, amazon_asin: 'B00006IE7K' },
  ...
  { category: 'Required', item_name: 'Towels', quantity: 2, notes: 'No wider than 24" x 44"', amazon_asin: 'B0CQ73P23P' },
