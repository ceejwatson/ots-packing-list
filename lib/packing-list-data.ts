...
export const defaultOTSPackingList: Omit<PackingItem, 'id' | 'is_packed'>[] = [
  ...
  { category: 'Required', item_name: 'Duffel bag', quantity: 1, notes: 'For field deployment', amazon_asin: 'B0CGJWKDPP' },
  ...
  { category: 'Required', item_name: 'Combination lock', quantity: 1, amazon_asin: 'B00004SQJ5' },
  ...
  { category: 'Recommended', item_name: 'Hangers', quantity: 10, amazon_asin: 'B07DKCFG1D' },
  { category: 'Recommended', item_name: 'Laundry detergent', quantity: 1, amazon_asin: 'B0BXW9WVWD' },
