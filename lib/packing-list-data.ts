...
export const defaultOTSPackingList: Omit<PackingItem, 'id' | 'is_packed'>[] = [
  ...
  { category: 'Required', item_name: 'Running shoes', quantity: 1, amazon_asin: 'B0D43J3N8B', image_url: '/images/running-shoes.jpg' },
  { category: 'Required', item_name: 'White V-neck undershirts', quantity: 2, notes: '3 recommended', amazon_asin: 'B004H4PUYQ', image_url: '/images/undershirts.jpg' },
  ...
  { category: 'Required', item_name: 'Shower shoes/flip flops', quantity: 1, amazon_asin: 'B07FDB7GMZ', image_url: '/images/shower-slides.jpg' },
  { category: 'Required', item_name: 'Toiletry bag', quantity: 1, amazon_asin: 'B0747N45S5', image_url: '/images/toiletry-bag.jpg' },
  { category: 'Required', item_name: 'Hard soap with case or shower gel', quantity: 1, amazon_asin: 'B002TSA91Q', image_url: '/images/bodywash.jpg' },
  { category: 'Required', item_name: 'Shampoo and conditioner', quantity: 1, amazon_asin: 'B0BR1VCK3C' },
  { category: 'Required', item_name: 'Personal hygiene items', quantity: 1, notes: 'Shaving, hair, feminine supplies for 60 days', amazon_asin: 'B07DZYGDS3', image_url: '/images/shaving.jpg' },
  { category: 'Required', item_name: 'Black backpack', quantity: 1, notes: 'IAW DAFI 36-2903, for 72-hour bag', amazon_asin: 'B0DCXN23RY', image_url: '/images/backpack.jpg' },
  { category: 'Required', item_name: 'Hydration pack (1.5L minimum)', quantity: 1, notes: 'Max 18"x12"x5", must have document pouch', amazon_asin: 'B0DZ6GB89C', image_url: '/images/hydration-pack.jpg' },
  { category: 'Required', item_name: 'Black ball point pens', quantity: 5, amazon_asin: 'B00006IE7K', image_url: '/images/black-pens.jpg' },
  { category: 'Required', item_name: 'Notepaper/pocket notebook', quantity: 2, amazon_asin: 'B00BQM0UEM', image_url: '/images/notebook.jpg' },
  { category: 'Required', item_name: 'Duffel bag', quantity: 1, notes: 'For field deployment', amazon_asin: 'B097M722RB', image_url: '/images/duffel-bag.jpg' },
  { category: 'Required', item_name: 'Towels and washcloths', quantity: 1, notes: 'No wider than 24" x 44", includes washcloths', amazon_asin: 'B0B2X5KRDM', image_url: '/images/washcloth.jpg' },
  { category: 'Required', item_name: 'Wristwatch', quantity: 1, notes: 'Smart watches authorized with restrictions', amazon_asin: 'B007RWZHXO', image_url: '/images/watch.jpg' },
  { category: 'Required', item_name: 'Flashlight', quantity: 1, notes: 'Less than 5 inches long, extra batteries', amazon_asin: 'B077BHV22W', image_url: '/images/flashlight.jpg' },
  { category: 'Required', item_name: 'Eye protection (wrap-around)', quantity: 1, notes: 'Must have fully enclosed sides', amazon_asin: 'B0DH4LH7YK', image_url: '/images/sunglasses.jpg' },
  { category: 'Required', item_name: 'Eyeglass strap', quantity: 1, notes: 'Required to secure glasses during field events', amazon_asin: 'B001D0F0J4' },
  { category: 'Required', item_name: 'Prescription eyeglasses', quantity: 2, notes: 'If needed, military-approved frames' },
  { category: 'Required', item_name: 'Combination lock', quantity: 1, amazon_asin: 'B07T2C3QNZ', image_url: '/images/combination-lock.jpg' },
  { category: 'Required', item_name: 'Gallon-sized ziplock bags', quantity: 5, notes: 'Clear', amazon_asin: 'B09TQVC1CT' },
  { category: 'Required', item_name: 'Sandwich-sized ziplock bags', quantity: 5, notes: 'Clear', amazon_asin: 'B09TQTXQN7' },
  ...
  { category: 'Recommended', item_name: 'Rechargeable fan', quantity: 1, notes: 'USB or battery powered for dorm', amazon_asin: 'B0CHCKWDJ8' },
  { category: 'Recommended', item_name: 'Electrolytes', quantity: 1, notes: 'For hydration pack', amazon_asin: 'B078XMP8KJ', image_url: '/images/electrolytes.jpg' },
  ...
  { category: 'Recommended', item_name: 'Laundry bag', quantity: 1, amazon_asin: 'B0876N5CP7' },
  { category: 'Recommended', item_name: 'Mesh laundry bag', quantity: 1, amazon_asin: 'B01FWWHFD8' },
  { category: 'Recommended', item_name: 'Starch', quantity: 1, notes: 'For uniforms', amazon_asin: 'B001VZDWI6' },
  { category: 'Recommended', item_name: 'Hangers', quantity: 10, amazon_asin: 'B07FP199PF', image_url: '/images/hangers.jpg' },
  { category: 'Recommended', item_name: 'Laundry detergent', quantity: 1, amazon_asin: 'B0BJMV9BXJ', image_url: '/images/tide-pods.jpg' },
  { category: 'Recommended', item_name: 'Sewing kit', quantity: 1, amazon_asin: 'B0D5TXGWLX' },
  { category: 'Recommended', item_name: 'Scissors', quantity: 1, amazon_asin: 'B002YIP97K' },
  { category: 'Recommended', item_name: 'Lint roller', quantity: 1, amazon_asin: 'B003E2YZGG' },
  { category: 'Recommended', item_name: 'Bug spray', quantity: 1, amazon_asin: 'B001ANQVYU', image_url: '/images/bug-spray.jpg' },
